...
class MainHvipDialog(QtWidgets.QDialog):
    ...
    def pushButton_ok_handler(self) -> None:
        ...
        self.root.send_comand_Modbus(
            dev_id=1, f_code=16, reg_cnt=6, comand=int(v_pips)
        )  # установка в 50В: 01 10 00 06 00 32 A1 DD
    ...
    def measure_voltage_pips(self):
        try:
            ...
            self.root.send_comand_Modbus(dev_id=1, f_code=16, comand=0, reg_cnt=self.root.HVIP_PIPS_READ_VOLTAGE)
