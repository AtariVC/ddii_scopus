...
class MainTrapezoidDialog(QtWidgets.QDialog):
    ...
    def pushButton_OK_handler(self) -> None:
        ...
        xtr_pips, ytr_pips = self.root.trapezoid_calculater(
            xpips, ypips, T_decay_pips, T_rise_pips, T_top_pips, invert_pips
        )
        xtr_sipm, ytr_sipm = self.root.trapezoid_calculater(
            xsipm, ysipm, T_decay_sipm, T_rise_sipm, T_top_sipm, invert_sipm
        )
